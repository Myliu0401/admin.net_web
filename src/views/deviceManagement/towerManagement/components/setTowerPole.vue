	...
	>
		<el-form v-loading="state.loading" ref="ruleFormRef" :model="form" :rules="rules" label-width="70px">
			...
			<el-form-item label="排序">
				<el-input v-model="form.orderNo" type="number" style="width: 70px" min="1" />
			</el-form-item>
			...
			<el-form-item label="直属线路" prop="lineId">
				<el-select
					v-model="form.xinzheng.provinceId"
					placeholder="省"
					size="small"
				...
				>
					<el-option
						v-for="item in stateData.province"
						:key="item.id"
						:label="item.name"
						:value="item.id"
					/>
				...
				>
					<el-option
						v-for="item in stateData.city[form.xinzheng.provinceId]"
						:key="item.id"
						:label="item.name"
						:value="item.id"
					/>
				...
				>
					<el-option
						v-for="item in stateData.area[form.xinzheng.cityId]"
						:key="item.id"
						:label="item.name"
						:value="item.id"
					/>
				...
				<el-select
					v-model="form.xinzheng.lineId"
					placeholder="线路"
					size="small"
					style="width: 100px !important; margin-right: 10px; margin-bottom: 5px"
				>
					<el-option
						v-for="item in stateData.line[form.xinzheng.gradeId]"
						:key="item.id"
						:label="item.name"
						:value="item.id"
					/>
