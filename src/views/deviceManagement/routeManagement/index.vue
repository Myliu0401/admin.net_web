<template>
	<div class="deviceManagement">
		<div class="leftNavigation">
			...
			<div class="accordion">
				<el-tree :data="state.data" :props="defaultProps" :highlight-current="true" accordion @node-click="handleNodeClick" />
			</div>
		</div>

		<div class="contentMain">
			<div class="contentMain_searchArea">
				<el-select v-model="state.equipmentNumber" clearable placeholder="设备编号" size="small" style="width: 150px; min-width: 150px; margin-right: 10px">
					<el-option v-for="item in state.deviceList" :key="item.value" :label="item.label" :value="item.value"> </el-option>
				</el-select>
				<el-input v-model="state.keyword1" suffix-icon="el-icon-search" placeholder="请输入搜索内容内容" size="small" style="margin-right: 10px; max-width: 200px"></el-input>
			...
			<div class="cotentMain_table">
				<el-table :data="state.tableData" height="max-height: 100%" :border="true" empty-text="暂无数据" style="width: 100%" v-loading="state.loading">
