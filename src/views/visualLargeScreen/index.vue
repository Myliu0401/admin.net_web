    ...
    <div class="visualLargeScreen">
        ...
        <div class="visualLargeScreen_content">
            ...
            <div class="optionSearchArea">
                ...
                <button class="search">搜索 <el-icon>
                        <ele-Search />
                    </el-icon></button>
            </div>
            ...
            <div class="switchingArea">
                <button class="button" :class="{ active: state.currentlySelectedMap === 'baiduMap' }"
                    @click="switchMaps('baiduMap')">百度地图</button>
                <button class="button" :class="{ active: state.currentlySelectedMap === 'echarts' }"
                    @click="switchMaps('echarts')">echarts</button>
            </div>
        </div>
...
onMounted(() => {
    setTimeout(() => {
        ...
        renderRateRingChart(chartDom.value);
        initCarouselChart();
