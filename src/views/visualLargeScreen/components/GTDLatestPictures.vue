<template>
	<div class="GTDLatestPictures">
		...
		<div class="GTDetails_content">
			...
			<el-image v-if="state.imgSrc" style="width: 90%; max-height: 90%" :src="state.ipurl + state.imgSrc" :zoom-rate="1.2" :max-scale="7" :min-scale="0.2" :preview-src-list="['http://8.134.249.156:5005/'+state.imgSrc]" :initial-index="0" fit="cover" />
		</div>
	</div>
</template>
