		...
		<div class="mainContent">
			...
			<div class="videoRecordingManagement_contentBox" :class="{ tableType: true }">
				<el-table :data="listData.lists" max-height="70vh" border style="width: 100%" v-loading="listData.loading">
					...
					<el-table-column prop="x1" label="告警区域-X1" align="center"> </el-table-column>
					<el-table-column prop="y1" label="告警区域-Y1" align="center"> </el-table-column>
					<el-table-column prop="x2" label="告警区域-X2" align="center"> </el-table-column>
					<el-table-column prop="y2" label="告警区域-Y2" align="center"> </el-table-column>
				</el-table>
